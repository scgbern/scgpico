...
-     **RaÃºl Marticorena** ([rmartico@ubu.es](rmartico@ubu.es)) \+ **Carlos LÃ³pez** (clopez@ubu.es) \+ Yania Crespo <br> [Parallel Inheritance Hierarchy Detection from a Static View of the System](%assets_url%/files/85/qb009d2szcyh7huuc6gc37zgnk5ok9/Parallel Inheritance Hierarchy Detection from a Static View of the System)
